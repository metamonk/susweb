...
export default function Home() {
  const handleCopy = () => {
    navigator.clipboard.writeText('keX1H7acGQmrUQMS3vsyUQJQqZvD6MLB8CR6Pgtpump');
  ...
  return (
    <main className="flex flex-col items-center justify-between p-6 sm:p-12 lg:p-24 bg-yellow-300 relative overflow-hidden">
      <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-purple-600 text-center mb-8 font-jersey text-3d">$SUS on Solana</h1>
      ...
      />
      <p className="text-lg font-bold sm:text-xl lg:text-2xl text-center max-w-md mb-8">Y&apos;all really be capping.</p>
      <div
        className="
        justify-center
        bg-purple-300
        ...
        onClick={handleCopy}
      >
        <code className="font-mono font-bold">keX1H7acGQmrUQMS3vsyUQJQqZvD6MLB8CR6Pgtpump</code>
      </div>
      <div>
        <MemeGenerator />
      </div>
